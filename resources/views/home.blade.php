<x-layout title="ConneCTION">
    <x-hero class="is-success">
        <div class="has-flex has-flex-direction-col ml-5 has-text-left">
            ...
            <div class="buttons">
                <a href="{{ URL::route('about') }}" class="button is-primary">Learn More</a>
                <a href="{{ URL::route('registration.create') }}" class="button is-primary is-outlined">Sign Up</a>
            </div>
        </div>
    </x-hero>
    <main class="column is-fullwidth mx-5">
        <section class="columns mt-5 mx-5">
            ...
            <div class="column is-one-third"
                ...
                <img src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2342&q=80"
